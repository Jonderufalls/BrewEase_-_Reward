                  ...
                  return Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 16),
                        Text('No items available', style: TextStyle(color: Colors.grey[600])),
                      ],
                    ),
                  );
                }
          ...
          children: [
            Container(
              ...
              child: item['image'] != null && item['image'].toString().isNotEmpty
                  ? Image.network(
                      item['image'],
                      fit: BoxFit.cover,
                      errorBuilder: (_, __, ___) => const Icon(Icons.coffee, size: 48, color: BrewEaseTheme.primaryBrown),
                    )
                  : const Icon(Icons.coffee, size: 48, color: BrewEaseTheme.primaryBrown),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(item['name'] ?? 'Unknown Item', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  ...
                  Text(
                    ...
                    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: BrewEaseTheme.accentOrange),
                  ),
                ],
              ),
            ),
                ...
                IconButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(isFavorite ? '❤️ Removed from favorites' : '❤️ Added to favorites'),
